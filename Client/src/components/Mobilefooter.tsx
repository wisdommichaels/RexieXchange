    ...
    <div>
      ...
      >
         <Link to={"/"}className="flex flex-col justify-center items-center">
          <img className="w-[30px] h-[30px]" src="https://res.cloudinary.com/duwfbyhyq/image/upload/v1730365077/homeicon_tjzfnn.svg" alt=""/>
        
            <p className=" text-[14px]"> Home </p>
        </Link>

        <Link to={"/sell"} className="flex flex-col justify-center items-center">
          <img className="w-[30px] h-[30px]" src="https://res.cloudinary.com/duwfbyhyq/image/upload/v1729740808/sellicon_lqtg0t.png" alt=""/>
        
            <p className=" text-[14px] "> Sell Card </p>
        </Link>

        <Link to={"/checkrate"} className="flex flex-col justify-center items-center">
          <img className="w-[30px] h-[30px]" src="https://res.cloudinary.com/duwfbyhyq/image/upload/v1729742009/icons8-estimate-50_er6vb4.png" alt=""/>
        
            <p className="text-[14px] "> Check Rate </p>
        </Link>

        <Link to={"/dashboard"} className="flex flex-col justify-center items-center">
          <img className="w-[30px] h-[30px]" src="https://res.cloudinary.com/duwfbyhyq/image/upload/v1729740808/dashboardicon_bpxaku.png" alt=""/>
