...
const Progress = () => {
  return (
    ...
    <div className="w-full rounded-lg sm:w-[40%] flex flex-col justify-center shadow-sm  shadow-[#bbd8e6] items-center m-auto bg-[#7E9ECF] mt-11">
        ...
        <button className="px-20 py-3 font-bold shadow-sm btnn  shadow-[#cff0ff] bg-gradient-to-r from-[#161d6f] to-[#1422bd] hover hover:bg-[#161d6f] text-white rounded-lg  mt-6 mb-8 text-[16px]">Ok</button>
    </div>
</section>
    </div>
  )
