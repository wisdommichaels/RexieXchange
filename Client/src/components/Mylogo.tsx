...
const Mylogo = () => {
  return (
    <div>
     <Link to={'/landingpage'} className="flex justify-center items-center cursor-pointer pl-3 sm:pl-0">
        <img className="sm:w-[80px] sm:h-[80px] w-[40px] h-[40px] sm:pb-9" src="https://res.cloudinary.com/duwfbyhyq/image/upload/v1734048565/logo_l22er0.webp" alt="" />
