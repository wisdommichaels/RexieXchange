  ...
  return (
    <div>
     <Link to={'/landingpage'} className="flex justify-center items-center cursor-pointer">
        ...
        <h1 className="font-bold sm:text-[20px] text-[14] sm:text-[#161D6F] text-white">RexieGift</h1>
        <p className="sm:text-[8px] text-[5.8px] sm:text-[#161D6F] font-bold text-center text-white">Exchange Made Easy</p>
        </div>
      </Link>
