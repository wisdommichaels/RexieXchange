...
import { useTestimonialStore } from "../store/testimonialStore";
  ...
  const TestimonialCard = () => {
    ...
    return (
        <div className="track flex justify-center items-end sm:my-5 gap-5">
        {reviews?.map((review) => (
      <div className="carousel-card w-[95%] sm:h-[200px] sm:w-[45%] bg-gradient-to-r from-[#a7b4ca] to-[#6d87ad] rounded-md m-auto px-3 flex-col justify-center items-center">
          <div className="flex-col justify-center items-center py-5  px-2">
            ...
            <p className="my-4 sm:text-[18px] text-[14px] px-2">{review.review}</p>
          </div>
      </div>
        ))}
    </div>
